...
from hypothesis.strategies import binary,\
    dictionaries, integers, lists, recursive, text

from homework04 import encode, decode


"""http://www.bittorrent.org/beps/bep_0003.html"""


SIMPLE_TYPES = integers() | binary()
...
@given(recursive(SIMPLE_TYPES,
                 lambda t: lists(t, 1) | dictionaries(binary(), t, min_size=1)))
